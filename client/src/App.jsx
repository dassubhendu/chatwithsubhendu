...
// let arr = [
//   {type: 'user', post: 'sasasaasas'},
//   {type: 'bot', post: 'ewewewewew'},
// ]
...
function App() {
  ...
  const fetchBotResponse = async () => {
    const {data} = await axios.post("https://chatgpt-app-vite-deploy.onrender.com", { input }, { 
      headers: {
